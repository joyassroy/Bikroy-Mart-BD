...
import { MapPin, Phone, CheckCircle, Package, User, ClipboardList, Loader2, Image as ImageIcon } from "lucide-react";
    ...
    <div className="space-y-5">
      ...
      {deliveries.length === 0 ? (
        ...
        <div className="space-y-4">
          {deliveries.map((del) => (
            <div key={del.id} className="bg-white rounded-2xl border border-[#E5E7EB] overflow-hidden">
              <div className="p-5">
