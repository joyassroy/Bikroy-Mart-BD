      ...
      <main className="max-w-[1200px] mx-auto px-3 sm:px-4 md:px-6 lg:px-10 py-3 sm:py-4">
        ...
        <div className="flex items-center gap-2 mb-3 lg:hidden">
          <form onSubmit={handleSearch} className="flex-1 flex">
            ...
            <button
              type="submit"
              className="bg-[#EC008C] text-white px-3 rounded-r-md hover:bg-[#D60071] transition flex items-center"
            >
              <Search size={14} />
            </button>
          </form>
        ...
        <div className="hidden lg:flex items-center gap-3 mb-3">
          <form onSubmit={handleSearch} className="flex-1 flex max-w-md">
            ...
            <button
              type="submit"
              className="bg-[#EC008C] text-white px-4 rounded-r-md hover:bg-[#D60071] transition flex items-center"
            >
              <Search size={16} />
            </button>
          </form>
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <div className="flex border border-[#E5E7EB] rounded-md overflow-hidden">
              <button
                ...
                className={`p-2 transition ${viewMode === "grid" ? "bg-[#EC008C] text-white" : "bg-white text-[#667085] hover:bg-[#F4F7FB]"}`}
              >
                <Grid3X3 size={14} />
              </button>
              <button
                onClick={() => setViewMode("list")}
                className={`p-2 transition ${viewMode === "list" ? "bg-[#EC008C] text-white" : "bg-white text-[#667085] hover:bg-[#F4F7FB]"}`}
              >
                <List size={14} />
              </button>
            </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mb-3 lg:hidden">
              ...
              <div className="flex border border-[#E5E7EB] rounded-md overflow-hidden">
                <button
                  onClick={() => setViewMode("grid")}
                  className={`p-2 transition ${viewMode === "grid" ? "bg-[#EC008C] text-white" : "bg-white text-[#667085]"}`}
                >
                  <Grid3X3 size={14} />
                </button>
                <button
                  onClick={() => setViewMode("list")}
                  className={`p-2 transition ${viewMode === "list" ? "bg-[#EC008C] text-white" : "bg-white text-[#667085]"}`}
                >
                  <List size={14} />
                </button>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2 mb-3">
                ...
                {selectedCategory && (
                  <span className="inline-flex items-center gap-1 bg-[#FCE8F3] text-[#EC008C] text-[10px] font-medium px-2 py-1 rounded-full">
                    ...
                    <button onClick={() => setSelectedCategory("")} className="hover:text-[#D60071]">
                      <X size={10} />
                    </button>
                  </span>
                )}
                {minPrice && (
                  <span className="inline-flex items-center gap-1 bg-[#E8F4F8] text-[#00AFCC] text-[10px] font-medium px-2 py-1 rounded-full">
                    Min: ৳{minPrice}
                    <button onClick={() => setMinPrice("")} className="hover:text-[#009AB5]">
                      <X size={10} />
                    </button>
                  </span>
                )}
                {maxPrice && (
                  <span className="inline-flex items-center gap-1 bg-[#E8F4F8] text-[#00AFCC] text-[10px] font-medium px-2 py-1 rounded-full">
                    Max: ৳{maxPrice}
                    <button onClick={() => setMaxPrice("")} className="hover:text-[#009AB5]">
                      <X size={10} />
                    </button>
                  </span>
                )}
                {searchQuery && (
                  <span className="inline-flex items-center gap-1 bg-[#E8EDF5] text-[#00215B] text-[10px] font-medium px-2 py-1 rounded-full">
                    &quot;{searchQuery}&quot;
                    <button onClick={() => setSearchQuery("")} className="hover:text-[#001A4A]">
                      <X size={10} />
                    </button>
                  </span>
                )}
                <button onClick={clearFilters} className="text-[10px] text-[#EC008C] font-semibold hover:underline">
                  {t.clearAll}
                </button>
              </div>
            )}
            ...
            {loading ? (
              ...
              <div className="text-center py-12 sm:py-16 bg-white rounded-lg border border-[#E5E7EB]">
                ...
                <button
                  ...
                  className="mt-3 text-[11px] text-[#EC008C] font-semibold hover:underline"
                >
                  {t.clearFilters}
                </button>
              </div>
                        ...
                        <button
                          ...
                          className={`w-8 h-8 text-[11px] font-medium rounded-md transition ${
                            currentPage === page
                              ...
                              : "border border-[#E5E7EB] bg-white text-[#364152] hover:bg-[#F4F7FB]"
                          }`}
                        >
                          {page}
                        </button>
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute right-0 top-0 h-full w-72 bg-white shadow-xl overflow-y-auto">
            <div className="flex items-center justify-between p-4 border-b border-[#E5E7EB]">
              ...
              <button
                onClick={() => setFilterDrawerOpen(false)}
                className="p-1.5 rounded-md hover:bg-[#F3F4F6] transition text-[#364152]"
              >
                <X size={18} />
              </button>
            </div>
